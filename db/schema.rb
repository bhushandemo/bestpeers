...
ActiveRecord::Schema.define(version: 2023_10_07_133723) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["car_id"], name: "index_companies_on_car_id"
  end
  ...
  create_table "schools", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["principle_id"], name: "index_schools_on_principle_id", unique: true
  end
  ...
  add_foreign_key "schools", "principles"
